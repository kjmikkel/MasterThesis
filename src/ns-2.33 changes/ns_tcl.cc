...
\"\n\
checkout_executable TCLSH \"/home/mikkel/Downloads/ns-allinone-2.33/bin/tclsh8.4\" tclsh \"\\\n\
When configured, ns found the right version of tclsh in\\\n\
/home/mikkel/Downloads/ns-allinone-2.33/bin/tclsh8.4\n\
but it doesn't seem to be there anymore, so\\\n\
...
\n\
set greedyonly [string first \"GREEDY\" [[$self set ragent_] info class]] \n\
if {$greedyonly != -1 } {\n\
[$self set ragent_] resetSB\n\
}\n\
\n\
...
GREEDY  # Greedy Routing (Routing Protocol)\n\
} {\n\
