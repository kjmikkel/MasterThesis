...
\begin{itemize}
\item[Movement models:] DisasterArea \cite{disasterArea},  Random Street \cite{randomStreet}, and Gauss-Markow \todo{find and cite}. In practise I will create a trace using the BonnMotion tool \cite{toilers} use to create the movement files which can then be imported into ns-2.
...
\item[Number of nodes:] 500, 1000\footnote{Neither GloMoSim or ns-2 can handle too many nodes \todo{find and cite their problems}}
