...
\def\network{{(0.5,0.5)/c}, {(1,1)/d}, {(0.5, 2.5)/e}, {(1.25, 2.5)/f}, {(1.25, 1.5)/g}, {(1.25, 0.5 )/h}, {(1.75, 0.5)/i}, {(1.80, 1.8)/j}, {(1.20, -1)/k}, {(1.40, -0.6)/l}, {(2.6, 0.7)/m}}
...
\begin{tikzpicture}  
    ...
    % The connections between them
   \foreach \source/\sink in {s/c, c/d, d/h, h/i, i/m, m/t} {
      \path[real edge] (\source) -- (\sink);
    }
