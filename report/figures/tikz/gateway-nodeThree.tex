...
\def\blankNodes{{(4.8, 2.3)/f}, {(5.5, 1.5)/g}, {(5.6, 2.6)/i}, {(6.6, 2.6)/r}, {(6.9, 2.2)/u}, {(6.4, 1.45)/v}, {(6.2, 0.9)/x}}
...
\tikzstyle{black}=[circle,fill=white!100, minimum size=10pt, inner sep=0pt]
