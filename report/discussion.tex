...
\graphResult{spanner/euclid_distance}{A closer look at the euclidean distance compared to the non-planar graph. Uses the same data as figure~\ref{graph:dist_percent}}{euclid_distance}
