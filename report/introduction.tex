...
\item[Section - ] Presentation of the test results
\item[Section - ] Discussion of the test results
\item[Section - ] Conclusion and wrap-up.
\end{description}
}\todo{give it a pass more to see if it can be improved}
