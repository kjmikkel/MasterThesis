...
\defi{When a node $n_x$ can transmit information to another node $n_y$ (i.e. $n_y$ lies within the range of $n_x$ transmitter), then I will say that $n_x$ is adjacent to }
\defi{When two nodes $n_x$ and $n_y$ can communicate with each other, I will say that there is a unidirectional link between $n_x$ and $n_y$}
