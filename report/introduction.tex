...
\defi{Topological movement is when the movement in the node causes a change in the routing graph.}
...
\defi{Given two nodes $n_x$ and $n_y$, I will say that there exists a unidirectional link between them, when $n_x$ is adjacent to $n_y$ and $n_y$ is adjacent to $n_x$.}
\defi{
When 2 nodes have a unidirectional link, and they are connected in the underlying routing graph, I will say that the two nodes are neighbours. I find this clarification necessary since }
