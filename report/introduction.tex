...
\item[Mobility:] How mobile are the nodes? How fast can they move? Can the nodes only realistically be integrated in a vehicula, or can a person be expected to carry them around on their person?
\item[]
\end{description}
