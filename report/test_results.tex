...
\graphResult{spanner/dist_percent}{The solid lines indicates the percentage of the total distance traversed for the \ac{gabe} and the \ac{rng}, compared to the non-planar graph, while the dashed lines indicates the same, but for hops instead of euclidean distance. The non-planar graph has been omitted as it in both cases would be a straight line at $100\%$.}{dist_percent}
