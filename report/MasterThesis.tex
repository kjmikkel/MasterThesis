...
Furthermore I will give a performance evaluation of my own implementation of the GOAFR algorithm\cite{gopher} compared to several other algorithms. I will also perform a comparison between the average distance  of two nodes in randomly generated non-planar graphs, compared to the \ac{gabe}\  and the \ac{rng} \cite{RNG}, compared to the average number of neighbours and edges in the graph.
}
